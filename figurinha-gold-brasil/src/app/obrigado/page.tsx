...
export default function ObrigadoCartao() {
  const handleShare = () => {
  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-copa-yellow px-5 py-8 overflow-hidden text-white">
      ...
      <div className="w-full max-w-md flex flex-col items-center animate-slide-up">
        {/* Badge aprovado */}
        <div className="flex items-center gap-2 bg-green-500/20 border border-green-400 rounded-full px-5 py-2 mb-4">
          <span className="text-green-400 text-xl">✓</span>
          <span className="text-green-400 font-bold text-sm tracking-widest">PAGAMENTO APROVADO</span>
        </div>
        ...
        <p className="text-xl text-center leading-relaxed mb-2" style={{ fontFamily: "var(--font-papernotes)" }}>
          Sua <strong className="text-copa-blue">figurinha GOLD personalizada</strong> vai chegar no seu{" "}
          <strong className="text-copa-blue">e-mail em até 30 minutos</strong>.
        </p>

        <p className="text-base text-copa-white/80 text-center mb-2" style={{ fontFamily: "var(--font-papernotes)" }}>
          O arquivo PDF vem pronto para imprimir, com 16 figurinhas no tamanho padrão (4,9 × 6,5 cm). 🇧🇷
        </p>

        <p className="text-sm text-copa-white/60 text-center mb-6" style={{ fontFamily: "var(--font-papernotes)" }}>
